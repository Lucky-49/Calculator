#![cfg_attr(not(debug_assertions), windows_subsystem = "windows")] //скрывает окно консоли в Windows в релизе

use eframe::egui;

use calculator::{keyboard, math_exp};

#[cfg(not(target_arch = "wasm32"))]
fn main() -> eframe::Result<()> {
    eframe::run_native(
        "calculator", //указываем наименование которое будет отображаться в строке заголовка приложения
